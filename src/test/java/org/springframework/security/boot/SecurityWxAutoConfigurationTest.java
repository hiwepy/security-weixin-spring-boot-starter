...
class SecurityWxAutoConfigurationTest {
    ...
    void testInstantiation() {
        SecurityWxAutoConfiguration configuration = new SecurityWxAutoConfiguration();
        assertThat(configuration).isNotNull();
    }

    @Test
    @DisplayName("Auto-configuration loads when 'spring.security.weixin.enabled=true'")
    ...
    void testNotLoadedWhenPropertyAbsent() {
        runner.withUserConfiguration(SecurityWxAutoConfiguration.class)
                .run(context -> assertThat(context).doesNotHaveBean(SecurityWxAutoConfiguration.class));
    }
}
