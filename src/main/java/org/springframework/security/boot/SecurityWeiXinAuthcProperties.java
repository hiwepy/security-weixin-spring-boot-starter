...
@ConfigurationProperties(SecurityWeiXinAuthcProperties.PREFIX)
@Getter
@Setter
@ToString
public class SecurityWeiXinAuthcProperties extends SecurityAuthcProperties {

	public static final String PREFIX = "spring.security.weixin.authc";
	
	/** the code parameter name. Defaults to "password". */
    private String jscodeParameter = WeiXinAuthenticationProcessingFilter.SPRING_SECURITY_FORM_JSCODE_KEY;
