...
**security-weixin-spring-boot-starter** is a Spring Boot starter that integrates **security-biz** for applications using security-biz. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume security-biz capabilities with minimal setup.
...
| JDK | `17` |
| Coordinates | `io.github.easy4j:security-weixin-spring-boot-starter:4.1.x.20260527-SNAPSHOT` |
